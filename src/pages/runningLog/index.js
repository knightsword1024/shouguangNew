...
import { Card, Form, Col, Row, Select, Input, Table, DatePicker, Modal, Spin } from 'antd';
...
class DataStatistics extends Component {
      ...
      <Fragment>
        <Form>
          <Row gutter={10}>
            ...
            <Col span={4}>
              <FormItem>
                <Select placeholder="所属网关" onChange={this.searchValue.bind(this, 'gateway')}>
                  <Option value="all" key="all">
                    全部
                  </Option>
  ...
  render() {
    const { formValues, modalVisible, rowValue, loading } = this.state;
    const parentMethods = {
